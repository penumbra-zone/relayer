...
func PenumbraMsg(rm provider.RelayerMessage) sdk.Msg {
	if val, ok := rm.(PenumbraMessage); !ok {
		fmt.Printf("got data of type %T but wanted provider.PenumbraMessage \n", val)
		return nil
	} else {
		return val.Msg
	}
...
func PenumbraMsgs(rm ...provider.RelayerMessage) []sdk.Msg {
	...
	for _, rMsg := range rm {
		if val, ok := rMsg.(PenumbraMessage); !ok {
			fmt.Printf("got data of type %T but wanted provider.PenumbraMessage \n", val)
			return nil
		} else {
...
func (pc PenumbraProviderConfig) NewProvider(
	log *zap.Logger,
	homepath string,
	debug bool,
) (provider.ChainProvider, error) {
...
func (cc *PenumbraProvider) CreateClient(
...
func (cc *PenumbraProvider) UpdateClient(
	srcClientId string,
	dstHeader ibcexported.Header,
) (provider.RelayerMessage, error) {
	var (
...
func (cc *PenumbraProvider) ConnectionOpenInit(
	...
	return []provider.RelayerMessage{updateMsg, NewPenumbraMessage(msg)}, nil
}

func (cc *PenumbraProvider) ConnectionOpenTry(
	ctx context.Context,
	dstQueryProvider provider.QueryProvider,
	dstHeader ibcexported.Header,
	srcClientId, dstClientId, srcConnId, dstConnId string,
) ([]provider.RelayerMessage, error) {
	var (
		acc string
		err error
	...
	clientState, clientStateProof, consensusStateProof, connStateProof, proofHeight, err := dstQueryProvider.GenerateConnHandshakeProof(
		ctx,
		cph,
		dstClientId,
		dstConnId,
...
func (cc *PenumbraProvider) ConnectionOpenAck(
	ctx context.Context,
	dstQueryProvider provider.QueryProvider,
	dstHeader ibcexported.Header,
	srcClientId, srcConnId, dstClientId, dstConnId string,
) ([]provider.RelayerMessage, error) {
	var (
		acc string
		err error
...
func (cc *PenumbraProvider) ConnectionOpenConfirm(
	ctx context.Context,
	dstQueryProvider provider.QueryProvider,
	dstHeader ibcexported.Header,
	dstConnId, srcClientId, srcConnId string,
) ([]provider.RelayerMessage, error) {
	var (
		acc string
		err error
...
func (cc *PenumbraProvider) ChannelOpenInit(
	srcClientId, srcConnId, srcPortId, srcVersion, dstPortId string,
...
func (cc *PenumbraProvider) ChannelOpenTry(
	ctx context.Context,
	dstQueryProvider provider.QueryProvider,
	dstHeader ibcexported.Header,
	srcPortId, dstPortId, srcChanId, dstChanId, srcVersion, srcConnectionId, srcClientId string,
) ([]provider.RelayerMessage, error) {
	var (
		acc string
		err error
...
func (cc *PenumbraProvider) ChannelOpenAck(
	ctx context.Context,
	dstQueryProvider provider.QueryProvider,
	dstHeader ibcexported.Header,
	srcClientId, srcPortId, srcChanId, dstChanId, dstPortId string,
) ([]provider.RelayerMessage, error) {
	var (
		acc string
		err error
...
func (cc *PenumbraProvider) ChannelOpenConfirm(
	ctx context.Context,
	dstQueryProvider provider.QueryProvider,
	dstHeader ibcexported.Header,
	srcClientId, srcPortId, srcChanId, dstPortId, dstChanId string,
) ([]provider.RelayerMessage, error) {
	var (
		acc string
		err error
...
func (cc *PenumbraProvider) ChannelCloseConfirm(
	ctx context.Context,
	dstQueryProvider provider.QueryProvider,
	dsth int64,
	dstChanId, dstPortId, srcPortId, srcChanId string,
) (provider.RelayerMessage, error) {
	var (
		acc string
		err error
...
// the header data.
func (cc *PenumbraProvider) GetIBCUpdateHeader(
	ctx context.Context,
	srch int64,
...
func (cc *PenumbraProvider) MsgRelayAcknowledgement(
	ctx context.Context,
	dst provider.ChainProvider,
...
func (cc *PenumbraProvider) MsgTransfer(
	amount sdk.Coin,
	dstChainId, dstAddr, srcPortId, srcChanId string,
...
func (cc *PenumbraProvider) MsgRelayRecvPacket(
	ctx context.Context,
	dst provider.ChainProvider,
	dsth int64,
	packet provider.RelayPacket,
...
func (cc *PenumbraProvider) RelayPacketFromSequence(
	...
	rcvPackets, timeoutPackets, err := relayPacketsFromResultTx(
		ctx,
		src,
		dst,
		int64(dsth),
...
func (cc *PenumbraProvider) AcknowledgementFromSequence(
	ctx context.Context,
	dst provider.ChainProvider,
	dsth, seq uint64,
	dstChanId, dstPortId, srcChanId, srcPortId string,
...
func relayPacketsFromResultTx(
	ctx context.Context,
	src, dst provider.ChainProvider,
	dsth int64,
	res *ctypes.ResultTx,
	dstChanId, dstPortId, srcChanId, srcPortId, srcClientId string,
) ([]provider.RelayPacket, []provider.RelayPacket, error) {
	var (
...
func acknowledgementsFromResultTx(
	dstChanId, dstPortId, srcChanId, srcPortId string,
	res *ctypes.ResultTx,
) ([]provider.RelayPacket, error) {
...
func (cc *PenumbraProvider) MsgUpgradeClient(
	srcClientId string,
	...
	return NewPenumbraMessage(&clienttypes.MsgUpgradeClient{
...
func (cc *PenumbraProvider) AutoUpdateClient(
	ctx context.Context,
	dst provider.ChainProvider,
...
func (cc *PenumbraProvider) FindMatchingClient(
	ctx context.Context,
	counterparty provider.ChainProvider,
	clientState ibcexported.ClientState,
) (string, bool) {
	...
	for _, identifiedClientState := range clientsResp {
		...
		if isMatchingClient(*tmClientState, *existingClientState) && existingClientState.FrozenHeight.IsZero() {
			...
			// query the latest consensus state of the potential matching client
			consensusStateResp, err := cc.QueryConsensusStateABCI(
				ctx,
				identifiedClientState.ClientId,
				existingClientState.GetLatestHeight(),
			)
			if err != nil {
				cc.log.Debug(
			...
			//nolint:lll
			header, err := counterparty.GetLightSignedHeaderAtHeight(
				ctx,
				int64(existingClientState.GetLatestHeight().GetRevisionHeight()),
			)
			if err != nil {
				cc.log.Debug(
...
func (cc *PenumbraProvider) QueryConsensusStateABCI(
	ctx context.Context,
	clientID string,
...
func (cc *PenumbraProvider) queryTMClientState(
	ctx context.Context,
	srch int64,
	srcClientId string,
) (*tmclient.ClientState, error) {
...
func msgToPenumbraAction(msg provider.RelayerMessage) (*penumbra_types.Action, error) {
	...
	if !ok {
		return nil, fmt.Errorf("message is not a penumbra message")
	}
		...
		return &penumbra_types.Action{
			Action: &penumbra_types.Action_IbcAction{IbcAction: &penumbra_types.IBCAction{
				Action: &penumbra_types.IBCAction_CreateClient{
					CreateClient: penMsg.Msg.(*clienttypes.MsgCreateClient),
				},
			}},
		}, nil
		...
		return &penumbra_types.Action{
			Action: &penumbra_types.Action_IbcAction{IbcAction: &penumbra_types.IBCAction{
				Action: &penumbra_types.IBCAction_UpdateClient{
					UpdateClient: penMsg.Msg.(*clienttypes.MsgUpdateClient),
				},
			}},
		}, nil
	default:
...
func (cc *PenumbraProvider) SendMessages(
	ctx context.Context,
